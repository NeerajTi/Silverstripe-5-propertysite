...
<html lang="$ContentLocale">
    <head>
        ...
        <link rel="stylesheet" href="themes/template/css/custom.css?ver=1.0.8">
...
.upload-card
{
    ...
    <body class="$ClassName.ShortName<% if not $Menu(2) %> no-sidebar<% end_if %> dashboardwrapper" <% if $i18nScriptDirection %>dir="$i18nScriptDirection"<% end_if %>>
