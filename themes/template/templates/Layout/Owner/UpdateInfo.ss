...
<div class="back_btn"><a href="javascript:void(0);" class="back-link prevstep"><i class="fa-solid fa-arrow-left"></i> Zur Übersicht</a></div>
 <h2>Personal Information  <i class="fa-solid fa-circle-info"></i></h2>
 <div class="media file-slot">
  ...
  <button class="delete-btn" data-field="BilderID" data-objectid="$PersonalInformation.ID" data-table='PersonalInformation' data-action='/owner-dashboard/deleteFileImg'><i class="fa-solid fa-trash"></i></button>
<% end_if %>
</div></div>
<div class="row mb-3">
					<div class="col-12">
					<!-- Upload label -->
					<label class="upload-box uploadtrigger" for="fileUpload" data-objectid="$PersonalInformation.ID" data-table='PersonalInformation' data-field="Bilder" data-action='/owner-dashboard/uploadFile' data-target="BilderIDInput">
