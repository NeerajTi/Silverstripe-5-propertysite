...
<div class="white_card" style="display:block;">
      ...
      <!-- PayPal JS SDK -->
<script src="https://www.paypal.com/sdk/js?client-id=ARtQeWNdiJY3aJXCr0y-XgnyNUYD6jLhhLVr5IyKacv59eMym5T-GaE8L_vtLQC78-6tsxYBr8DU7yIE&currency=EUR&disable-funding=card"></script> 
        <script>
paypal.Buttons({
              ...
              .then(data => {
                  ...
                  Swal.fire({
                    ...
                    if (result.isDismissed) {
                        window.location.href = '/payment/payment-thankyou';
                    }
                });
              });
        });
