...
<input type="hidden" name="SecurityID" value="$SecurityID">
		...
		<div class="global_custom_form white_100 width_1360">
		  <h2>$Title <span class="btn btn-secondary" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Information">Info</span></h2>
...
<img src="" alt="User Placeholder" class="upload-preview" style="max-width:180px; display:none; margin-top:10px;display:none">
						...
						<!-- Upload label -->
					<label class="upload-box uploadtrigger" data-table='MemberCompanyData' data-action='/registration/uploadFile' data-field="Image" for="fileUpload" data-target="BilderIDInput">
