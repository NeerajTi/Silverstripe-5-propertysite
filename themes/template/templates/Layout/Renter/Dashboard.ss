		...
		<div class="login_dashboard">
			<div class="container">
				...
				<div class="dashboard_cards">
					...
					<div class="cards">
						<a href="/renter-dashboard/info">
							<div class="icon"><i class="fa-solid fa-user"></i></div>
							<div class="text">
								<h3>Meine daten</h3>
								<p>Alle deine daten auf einen platz</p>
							</div>
						</a>
					</div>
					<div class="cards">
						<a href="/renter-dashboard/wishlist">
							<div class="icon"><i class="fa-solid fa-heart"></i></div>
							<div class="text">
								<h3>Favoriten</h3>
								<p>Gemerkte Objekten</p>
							</div>
						</a>
					</div>
					<div class="cards">
					...
					<div class="cards">
						<a href="/renter-dashboard/subscription">
							<div class="icon"><i class="fa-solid fa-star"></i></div>
							<div class="text">
								<h3>Abonnoment</h3>
								<p>Sneller een woning vinden (abbonoment)</p>
							</div>
						</a>
					</div>
					<div class="cards">
						<a href="/renter-dashboard/schufa">
							<div class="icon"><i class="fa-solid fa-file"></i></div>
							<div class="text">
								<h3>SCHUFA - BonitätsCheck</h3>
								<p>Ein ubersicht von alle benachrichtigte wohnungen</p>
							</div>
						</a>
					</div>
					<div class="cards">
						<a href="/renter-dashboard/tips">
